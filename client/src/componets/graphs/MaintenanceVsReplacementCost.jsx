...
const MaintenanceVsReplacementCost = ({ data, onClose }) => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold">Maintenance vs Replacement Cost</h2>
...
export default MaintenanceVsReplacementCost;
